   ...
   private static final int NUMBER_OF_PRODUCTS = 20000;
    ...
    private static void runLookups(final ProductLookupTable lookupTable)
    {
        ...
        for (int i = 0; i < ITERATIONS; i++)
        {
            ...
            checkResultofTable(lookupTable, products);
	...
	public static void checkResultofTable(final ProductLookupTable lookupTable, final List<Product> products) {
		for (Product product : products)
		{
